...
export default function CandidateOnboarding() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-80 bg-gray-50 border-b md:border-r border-gray-100 p-6 md:p-8 md:h-screen md:sticky md:top-20">
          ...
          {step === 1 && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <header>
                ...
                <p className="text-gray-500 mt-2 text-lg">Introduce yourself to the network.</p>
              </header>
          ...
          {step === 2 && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <header>
                ...
                <p className="text-gray-500 mt-2 text-lg">Add your tech stack and experience.</p>
              </header>
              <div className="space-y-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Skills (Type & Press Enter)</label>
                  <div className="w-full p-3 rounded-2xl bg-gray-50 min-h-[60px] flex flex-wrap gap-2 items-center focus-within:ring-2 focus-within:ring-blue-600 transition-all">
                    {skills.map(s => (
          ...
          {step === 3 && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
              <header>
                ...
                <p className="text-gray-500 mt-2 text-lg">Highlight your best work.</p>
              </header>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2 items-center pt-2">
                        ...
                        <input 
                          ...
                          className="text-[10px] uppercase font-bold tracking-widest outline-none bg-transparent w-32"
                          enterKeyHint="done"
